  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <a href="/" className="mt-6 inline-flex rounded-md bg-accent text-accent-foreground px-4 py-2 text-sm font-medium">Go home</a>
      </div>
    </div>
  );
}
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <button
          ...
          className="mt-6 rounded-md bg-accent text-accent-foreground px-4 py-2 text-sm font-medium"
        >Try again</button>
      </div>
    </div>
  );
